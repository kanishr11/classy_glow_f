        ...
        case 'cod':
          ...
          case 'razorpay':
            ...
            if(responseRazorpay.data.success){
              // console.log(responseRazorpay.data.orderData)
  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h[80vh] border-t'>
      ...
      <div className='flex flex-col gap-4 w-full sm:max-w-[480px]'>
        ...
        <input required onChange={onChangeHandler} name='email' value={formData.email} type="email" className='border border-gray-300 py-1.5 px-3.5 w-full' placeholder='E-mail address'/>
        ...
        <div className='flex gap-3'>
          <input required onChange={onChangeHandler} name='zipcode' value={formData.zipcode} type="number" className='border border-gray-300 py-1.5 px-3.5 w-full' placeholder='Zipcode'/>
        ...
        <input required onChange={onChangeHandler} name='phone' value={formData.phone} type="number" className='border border-gray-300 py-1.5 px-3.5 w-full' placeholder='Phone'/>
      </div>
      {/* Right side */}
      <div className='mt-8'>
